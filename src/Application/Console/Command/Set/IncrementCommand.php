...
final class IncrementCommand extends Command
{
    ...
    protected static $defaultName = 'app:incr';
    ...
    protected function configure()
    {
        ...
        $this
            ->setDescription("Increment a set by key.")
            ->setHelp("This command allows you to increment a set value by key.");
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $response = $this->client->send(Connection::PUT, "/increment/{$key}");
